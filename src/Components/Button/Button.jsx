  ...
  return (
    <>
      {props.type == "red" ? (
        ...
        hover:drop-shadow-2xl hover:shadow-eft-red-button hover:bg-white/10 hover:border-2 hover:border-eft-red-button hover:text-eft-red-button-hover
        ...
        hover:drop-shadow-2xl hover:shadow-eft-yellow hover:bg-white/10 hover:border-2 hover:border-eft-yellow hover:text-eft-yellow-hover
